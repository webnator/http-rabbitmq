...
module.exports = ({
  ...
  return {
    ...
    publishHTTPToTopic(key, { payload, headers, query, params }) {
      let msg = createHTTPRequest(payload, headers, query, params);
      return this.publishToTopic({ key, msg });
    },

    publishToTopic({ key, msg }) {
      return this.publishRetry({ key, msg });
    },
